...
import { HealthSectionImgRight, HealthSectionImgLeft } from "@/components/sections2/BioHaloSections/HealthSection";
...
export default function Landing6() {
  ...
  return (
    <main
      className="min-h-screen bg-gradient-to-br from-lightGrey via-mintAccent/50 to-tealAccent/70 overflow-hidden"
    >
