...
export function PollutionSection({ stats, className = "" }: PollutionSectionProps) {
...
export function PollutionSectionBACKUP({ stats, className = "" }: PollutionSectionProps) {
  const refMD = useRef(null);
  const refLG = useRef(null);
  ...
  return (
    ...
    >
      ...
      {/*Two Columns POLLUTION */}
      <div className="flex gap-8 w-full h-[1000px] xl:h-[800px] 2xl:h-[40vw] mt-0 md:-mt-14 "
      ref={refLG}>
