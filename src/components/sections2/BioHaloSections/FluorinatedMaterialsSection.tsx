...
const Circle1 = React.memo(function Circle1() {
  return (
    ...
    before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-tr before:from-tealAccent before:via-tealAccent before:to-mintAccent before:mix-blend-multiply before:opacity-20 before:"
    >
      <Image
          ...
          <div className="w-full h-full max-w-[1280px] mx-auto px-14  pt-[50px] -mb-[0px]">
            ...
            <div className="mt-0 flex flex-row gap-8 min-w-[1280px] lg:h-full h-[1000px] ">
              ...
              <div className="w-1/2 h-[1400px] bg-green-600/0 relative lg:mt-0 -mt-32">
                ...
                {/* Circle 2 */}
                <div
                  className="w-[550px] h-[550px] absolute top-[0] right-[18%] ml-auto translate-y-[15%] translate-x-[5%] bg-green-500/0"
                  style={{ willChange: "transform" }}
                >
                  <Circle2 />
                </div>
                ...
                {/* Circle 4 V2 */}
                <div
                  className="w-[1200px] h-[1200px] hidden absolute bottom-[-10%] right-[120%] ml-auto translate-y-[40%] -translate-x-[6%] bg-green-500/0"
                  style={{ willChange: "transform" }}
                >
                  <Circle4 />
                </div>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      ...
                      <SimpleStatsBox
                        ...
                        classNamesTitle="lg-9xl w-[800px] scale-[2.2] blur-sm opacity-35 text-center lg:text-9xl md:text-8xl 
                                    font-bold -mb-8 bg-gradient-to-tl from-lightGrey via-gray-400 to-lightGrey/70 bg-clip-text text-transparent"
                      ...
                      <SimpleStatsBox
                        ...
                        classNamesTitle="lg-9xl w-[800px] scale-[2.2] text-center lg:text-9xl md:text-8xl 
                                    font-bold -mb-8 bg-gradient-to-tl from-lightGrey via-gray-400 to-lightGrey/70 bg-clip-text text-transparent"
                        classNamesSubTitle="text-center text-lightGrey/60 text-3xl font-bold mt-20 capitalize"
                        stat={stats[4]}
                        scrollYProgress={scrollYProgress}
                ...
                {/* Circle 4 */}
                <div
                  className="block xl:hidden w-[700px] h-[700px] absolute top-[50%] left-0 translate-y-[35%] -translate-x-[120%]"
                  style={{ willChange: "transform" }}
                >
