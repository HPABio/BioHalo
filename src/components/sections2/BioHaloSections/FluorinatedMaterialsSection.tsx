              ...
              <div className="w-1/2 h-[1400px] bg-green-600/0 relative lg:mt-0 -mt-32">
                ...
                <div className="w-[350px] h-[350px] absolute top-[-10%] right-[0%] ml-auto translate-y-[15%] translate-x-[5%] bg-green-500/0">
                  <RasterizeComponent
                    ...
                    componentName="FluorinatedMaterialsSection_Circle1"
                  >
                    <div
                      className="relative w-[350px] h-[350px] rounded-full overflow-hidden border-2 border-lightGrey/40 grid place-items-center
                      before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-tr before:from-tealAccent before:via-tealAccent before:to-mintAccent before:mix-blend-multiply before:opacity-20 before:z-10"
                    >
                      {/* Background Image - Fully Covers Parent */}
                      <Image
                      ...
                      {/* EcoliTriplets Image - Slightly Larger than Parent */}
                      <div
                        className="absolute w-[110%] h-[110%] min-w-[110%] min-h-[110%] 
                       top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-20"
                      >
                        <EcoliTripletsSVG
                ...
                {/* Circle 2 - Example with rasterization disabled */}
                <div className="w-[550px] h-[550px] absolute top-[0] right-[18%] ml-auto translate-y-[15%] translate-x-[5%] bg-green-500/0">
                  <RasterizeComponent
                    ...
                    maxRetries={5}
                    saveToAssets={saveToAssets}
                    componentName="FluorinatedMaterialsSection_Circle2"
                  >
                    <div
                      className="relative w-[550px] h-[550px] grid place-items-center rounded-full overflow-hidden border-2 border-lightGrey/40
                      before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-tr before:from-tealAccent before:via-gray-800 before:to-gray-800 before:mix-blend-multiply before:opacity-0 before:z-10"
                    >
                      {/* Background Image */}
                      <Image
                      ...
                      {/* EcoliTriplets Image (110% size, centered naturally) */}
                      <div
                ...
                <div className="w-[1200px] h-[1200px] hidden absolute bottom-[-10%] right-[120%] ml-auto translate-y-[40%] -translate-x-[6%] bg-green-500/0">
                  <RasterizeComponent
                    ...
                    maxRetries={5}
                    saveToAssets={saveToAssets}
                    componentName="FluorinatedMaterialsSection_Circle4V2"
                  >
                    <div className="relative w-full h-full grid place-items-center rounded-full overflow-hidden border-2 border-lightGrey/40">
                      {/* Background Image */}
                      <Image
                      ...
                      {/* EcoliTriplets Image (110% size, placed naturally) */}
                      <div
                        className="w-[110%] h-[110%] min-w-[110%] min-h-[110%] 
                ...
                <div className="w-[900px] h-[900px] absolute bottom-[20%] right-[45%] ml-auto translate-y-[15%] translate-x-[5%] bg-green-500/0">
                  <div className="relative w-[900px] h-[900px]">
                    <RasterizeComponent
                      ...
                      maxRetries={5}
                      saveToAssets={saveToAssets}
                      componentName="FluorinatedMaterialsSection_Circle3"
                    >
                      <div
                        className="relative w-[900px] h-[900px] grid place-items-center rounded-full overflow-hidden
                        before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-tr before:from-tealAccent before:via-tealAccent/80 before:to-tealAccent/40 before:opacity-100 before:z-10
                        after:content-[''] after:absolute after:inset-0 after:rounded-full after:bg-gradient-to-tr after:from-black after:via-black/80 after:to-black after:opacity-80 after:border-2 after:border-lightGrey/50 after:z-20"
                      >
                        {/* Background Image */}
                        <Image
                          src={Droplets1}
                        ...
                        {/* Border Overlay */}
                        <div className="w-full h-full border-2 border-lightGrey opacity-80 absolute inset-0 z-30"></div>

                        {/* EcoliTriplets Image (110% size, placed naturally) */}
                        <div
                          className="w-[110%] h-[110%] min-w-[110%] min-h-[110%] 
                        absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-40"
                        >
                          <EcoliTripletsSVG
                            className="w-full h-full opacity-70 invert mix-blend-color-burn"
                            style={{
                ...
                <div className="block xl:hidden w-[700px] h-[700px] absolute top-[50%] left-0 translate-y-[35%] -translate-x-[120%]">
                  <RasterizeComponent
                    ...
                    maxRetries={5}
                    saveToAssets={saveToAssets}
                    componentName="FluorinatedMaterialsSection_Circle4"
                  >
