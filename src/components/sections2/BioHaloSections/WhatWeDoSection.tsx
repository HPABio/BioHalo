  ...
  return (
    <section className={`${className} overflow-visible`}>
      ...
      <div className="bg-black/0 text-gray-800/70 pt-8 w-[1200px] relative">
        ...
        />
        {/* Header Section */}
        <div className="space-y-16 bg-red-500/0">
          {/* Top Text Section */}
          <div className="space-y-4">
            ...
            <p className="text-lg max-w-md pt-4 leading-relaxed">
              Ferment is a company creation studio building new businesses that
              rapidly translate biology into products that solve targeted
              problems across energy, materials, agriculture, health and beyond.
            </p>
          </div>
        </div>
      </div>
