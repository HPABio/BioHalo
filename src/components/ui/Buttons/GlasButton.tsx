...
const GlasButton: React.FC = () => {
  return (
    <div className="relative w-screen h-screen flex items-center justify-center bg-[rgba(215,215,215,1)] overflow-hidden font-inter">
      ...
      {/* Button Container */}
      <div className="button-wrap relative z-10 rounded-full pointer-events-none transition-all duration-400 ease-[cubic-bezier(0.25,1,0.5,1)]">
        <button className="relative rounded-full bg-gradient-to-br from-white/5 via-white/20 to-white/5 shadow-inner focus:outline-none transition-all duration-400 ease-[cubic-bezier(0.25,1,0.5,1)]">
